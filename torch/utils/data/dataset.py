...
class ChunkDataset(IterableDataset):
    ...
    In this context, a chunk could be a file, contents of a folder,
    section of large text file, etc. In distributed training, to eliminate different workers reading
